...
export function createFanSegments() {
    ...
    const bands = [
        { rIn: 2.25, rOut: 2.65, color: 0x8e1d38, depth: 0.018, height: 0.15 }, // Maroon / Dark Red
        { rIn: 2.65, rOut: 3.05, color: 0x286b35, depth: 0.018, height: 0.15 }, // Green
        { rIn: 3.05, rOut: 3.45, color: 0xff861c, depth: 0.018, height: 0.15 }, // Orange
        { rIn: 3.45, rOut: 3.85, color: 0xffd72f, depth: 0.018, height: 0.15 }, // Yellow
        { rIn: 3.85, rOut: 4.35, color: 0xfff4dc, depth: 0.018, height: 0.15 }  // White/Cream Outer Arc
    ];
